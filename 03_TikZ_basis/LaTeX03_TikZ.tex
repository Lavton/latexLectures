...
\subtitle{The bases of TikZ}
\author{Anton Lioznov}
\institute{Skoltech}
\date{ISP 2019,\\ \textit{lesson 3}}
\frame{\titlepage}
...
\section{Introduction: on approaches to TikZ}
\input{sec01/sec01}

% general -> path - draw, fill, circle, rectangle, coordintates. Nodes. 
% graphs 
