...
\begin{frame}[fragile]{Cons}\relax
     \begin{itemize}
        \item[$-$] when you want to put something in {\csk attributary position} %\vspace{-1ex}
...
\begin{frame}{Pros}\relax
     \begin{itemize}
        ...
        \item[$+$] When you carry about {\csk device-independant} view and edit %\vspace{-1ex}
        \item[$+$] When you don't want {\csk not care about the beauty}, but want it%\vspace{-1ex}
        \item[$+$] When you are {\csk care about the beauty} wery much%\vspace{-1ex}
        \inClass{\item[$+$] When you hate all these {\csk humanitarian} GUI programs}
        \item[$+$] When you {\csk love text files} 
        \inClass{\item[$+$] When you want to {\csk impress} your partner}
    \end{itemize}
\end{frame}
