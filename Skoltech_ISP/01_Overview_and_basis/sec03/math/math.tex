...
\begin{frame}[fragile]{Brackets}\relax
...
\cprotect\outclassframe{\begin{frame}[fragile]{Brackets\magicPage}\relax
...
\lstinline[basicstyle=\tt]|$$\frac{x+1}{y} = z; \hbox{if $x - 1 < y$, but not always!}$$| \inpause \hfill or~\ccol{\text}~from~{\csk amsmath}~package.  
